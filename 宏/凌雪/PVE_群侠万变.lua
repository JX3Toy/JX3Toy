--[[ 奇穴: [秋霁][雪覆][折意][风骨][北阙][渊岳][玄肃][飞刃回转][百节][忘断][徵逐][青山共我]
秘籍:
星垂	1会心 3伤害
金戈	2会心 2伤害
寂洪荒	3伤害
...
function Main(g_player)
	...
	v["百节层数"] = buffsn("百节")			--实际效果 15927 15928 15929
	v["百节时间"] = bufftime("百节")		--5秒
	v["忘断时间"] = bufftime("忘断")		--10秒
	...
	if fight() and rela("敌对") and dis() < 12 and face() < 60 and cdleft(16) <= 0 and castleft() <= 0  and gettimer("寂洪荒") > 0.3 and gettimer("乱天狼") > 0.3 and state("站立|走路|跑步|跳跃") then
		PrintInfo("----------没打技能, ")
	end
end
