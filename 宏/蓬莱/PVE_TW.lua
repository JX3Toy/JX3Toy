--[[
奇穴: [淵壑][扶桑][羽彰][清源][海碧][風馳][驚潮][悵歸][溯徊][馳行][夢悠][濯流]
秘籍:
击水 1会心 3伤害
木落 1会心 3伤害
定波 2调息 2消耗
...
function Main(g_player)
	...
	-------------------------------------------------------地面
		...
		--定波快充能结束
		if cntime("定波砥瀾", true) < cdinterval(16) then
	...
	if fight() and rela("敌对") and dis() < 20 and cdleft(16) <= 0 and castleft() <= 0 and cdleft(1424) <= 0 and gettimer("定波砥澜") > 0.3 and state("站立|輕功") then
		PrintInfo("----------没打技能, ")
	end
end
